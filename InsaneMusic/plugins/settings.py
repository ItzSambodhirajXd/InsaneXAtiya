...
from InsaneMusic.utils.database import (add_nonadmin_chat,
...
from InsaneMusic.utils.database import get_served_users, get_served_chats
...
async def gib_repo(client, CallbackQuery, _):
    await CallbackQuery.edit_message_media(
        InputMediaVideo("https://te.legra.ph/file/6e36ab8575005b9762f8e.mp4"),
