...
from InsaneMusic import (Apple, Resso, SoundCloud, Spotify, Telegram,
                        YouTube, app)
...
from InsaneMusic.utils.inline.play import (livestream_markup,
                                          playlist_markup,
                                          slider_markup, track_markup)
from InsaneMusic.utils.database import is_served_user
...
async def play_commnd(
    ...
    if audio_telegram:
        ...
        if await YouTube.exists(url):
            ...
            try:
                await InsaneMusic.stream_call(url)
...
@app.on_callback_query(
    filters.regex("InsaneMusicymousAdmin") & ~BANNED_USERS
)
async def InsaneMusicymous_check(client, CallbackQuery):
    try:
        await CallbackQuery.answer(
...
@app.on_callback_query(
    filters.regex("InsaneMusicPlaylists") & ~BANNED_USERS
)
@languageCB
