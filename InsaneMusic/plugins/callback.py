...
from InsaneMusic.utils.inline import (
    stream_markup,
    stream_markup_timer,
    telegram_markup,
...
async def del_back_playlist(client, CallbackQuery, _):
    ...
    if command == "Pause":
        ...
        await InsaneMusic.pause_stream(chat_id)
        ...
        await InsaneMusic.resume_stream(chat_id)
        await CallbackQuery.message.reply_text(
