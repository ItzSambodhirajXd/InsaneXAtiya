...
from InsaneMusic.utils.database import (add_active_chat,
                                       add_active_video_chat,
                                       is_active_chat,
                                       is_video_allowed, music_on)
from InsaneMusic.utils.exceptions import AssistantErr
from InsaneMusic.utils.inline.play import (stream_markup, queue_markup,
                                          telegram_markup)
...
from InsaneMusic.utils.thumbnails import gen_thumb, gen_qthumb
...
async def stream(
    ...
    if forceplay:
        await InsaneMusic.force_stop_stream(chat_id)
